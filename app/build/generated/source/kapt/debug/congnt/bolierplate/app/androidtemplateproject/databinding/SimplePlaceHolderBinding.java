...
public class SimplePlaceHolderBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private congnt.bolierplate.app.androidtemplateproject.core.Dummy mItem;
    @Nullable
    private congnt.bolierplate.app.androidtemplateproject.core.Dummy mListener;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((congnt.bolierplate.app.androidtemplateproject.core.Dummy) variable);
        }
        else if (BR.listener == variableId) {
            setListener((congnt.bolierplate.app.androidtemplateproject.core.Dummy) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable congnt.bolierplate.app.androidtemplateproject.core.Dummy Item) {
        this.mItem = Item;
    }
    @Nullable
    public congnt.bolierplate.app.androidtemplateproject.core.Dummy getItem() {
        return mItem;
    }
    public void setListener(@Nullable congnt.bolierplate.app.androidtemplateproject.core.Dummy Listener) {
        this.mListener = Listener;
    }
    @Nullable
    public congnt.bolierplate.app.androidtemplateproject.core.Dummy getListener() {
        return mListener;
    }
    ...
    public static SimplePlaceHolderBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<SimplePlaceHolderBinding>inflate(inflater, congnt.bolierplate.app.androidtemplateproject.R.layout.simple_place_holder, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static SimplePlaceHolderBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(congnt.bolierplate.app.androidtemplateproject.R.layout.simple_place_holder, null, false), bindingComponent);
    }
    @NonNull
