...
import congnt.bolierplate.app.androidtemplateproject.db.dao.ExampleDao_Impl;
import congnt.bolierplate.app.androidtemplateproject.db.dao.PostDao;
import congnt.bolierplate.app.androidtemplateproject.db.dao.PostDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoExample.equals(_existingExample)) {
          throw new IllegalStateException("Migration didn't properly handle Example(congnt.bolierplate.app.androidtemplateproject.db.entities.Example).\n"
                  + " Expected:\n" + _infoExample + "\n"
                  + " Found:\n" + _existingExample);
        }
        ...
        if (! _infoPost.equals(_existingPost)) {
          throw new IllegalStateException("Migration didn't properly handle Post(congnt.bolierplate.app.androidtemplateproject.db.entities.Post).\n"
                  + " Expected:\n" + _infoPost + "\n"
                  + " Found:\n" + _existingPost);
        }
      }
