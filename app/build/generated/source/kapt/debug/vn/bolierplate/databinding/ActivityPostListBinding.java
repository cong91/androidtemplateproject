...
public class ActivityPostListBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private vn.bolierplate.ui.list.PostListViewModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((vn.bolierplate.ui.list.PostListViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable vn.bolierplate.ui.list.PostListViewModel ViewModel) {
    ...
    @Nullable
    public vn.bolierplate.ui.list.PostListViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected void executeBindings() {
        ...
        vn.bolierplate.ui.list.PostListViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            vn.bolierplate.utils.BindingAdaptersKt.setMutableVisibility(this.mboundView1, viewModelGetLoadingVisibility);
        }
    }
    ...
    public static ActivityPostListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityPostListBinding>inflate(inflater, vn.bolierplate.R.layout.activity_post_list, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityPostListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(vn.bolierplate.R.layout.activity_post_list, null, false), bindingComponent);
    }
    @NonNull
