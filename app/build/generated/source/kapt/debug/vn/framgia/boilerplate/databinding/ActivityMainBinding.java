...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private vn.framgia.boilerplate.ui.main.MainActivityViewModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((vn.framgia.boilerplate.ui.main.MainActivityViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable vn.framgia.boilerplate.ui.main.MainActivityViewModel ViewModel) {
    ...
    @Nullable
    public vn.framgia.boilerplate.ui.main.MainActivityViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected void executeBindings() {
        ...
        vn.framgia.boilerplate.ui.main.MainActivityViewModel viewModel = mViewModel;
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, vn.framgia.boilerplate.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(vn.framgia.boilerplate.R.layout.activity_main, null, false), bindingComponent);
    }
    @NonNull
