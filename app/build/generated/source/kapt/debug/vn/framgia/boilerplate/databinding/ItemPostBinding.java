...
public class ItemPostBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private vn.framgia.boilerplate.db.entities.Post mItem;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((vn.framgia.boilerplate.db.entities.Post) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable vn.framgia.boilerplate.db.entities.Post Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    @Nullable
    public vn.framgia.boilerplate.db.entities.Post getItem() {
        return mItem;
    }
    ...
    protected void executeBindings() {
        ...
        vn.framgia.boilerplate.db.entities.Post item = mItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            vn.framgia.boilerplate.utils.BindingAdaptersKt.setMutableText(this.postBody, itemBody);
            vn.framgia.boilerplate.utils.BindingAdaptersKt.setMutableText(this.postTitle, itemTitle);
        }
    }
    ...
    public static ItemPostBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemPostBinding>inflate(inflater, vn.framgia.boilerplate.R.layout.item_post, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemPostBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(vn.framgia.boilerplate.R.layout.item_post, null, false), bindingComponent);
    }
    @NonNull
