...
public class SimplePlaceHolderBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private vn.framgia.boilerplate.core.Dummy mItem;
    @Nullable
    private vn.framgia.boilerplate.core.Dummy mListener;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((vn.framgia.boilerplate.core.Dummy) variable);
        }
        else if (BR.listener == variableId) {
            setListener((vn.framgia.boilerplate.core.Dummy) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable vn.framgia.boilerplate.core.Dummy Item) {
        this.mItem = Item;
    }
    @Nullable
    public vn.framgia.boilerplate.core.Dummy getItem() {
        return mItem;
    }
    public void setListener(@Nullable vn.framgia.boilerplate.core.Dummy Listener) {
        this.mListener = Listener;
    }
    @Nullable
    public vn.framgia.boilerplate.core.Dummy getListener() {
        return mListener;
    }
    ...
    public static SimplePlaceHolderBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<SimplePlaceHolderBinding>inflate(inflater, vn.framgia.boilerplate.R.layout.simple_place_holder, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static SimplePlaceHolderBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(vn.framgia.boilerplate.R.layout.simple_place_holder, null, false), bindingComponent);
    }
    @NonNull
